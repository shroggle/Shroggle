...
public class ConfigureShoppingCartServiceTest {

    private final Persistance persistance = ServiceLocator.getPersistance();
    private final ConfigureShoppingCartService service = new ConfigureShoppingCartService();
    ...
    public void showFromSiteEditPage() throws Exception {
        ...
        DraftShoppingCart shoppingCart = TestUtil.createShoppingCart(site);
        ...
        Assert.assertEquals(shoppingCart.getId(), service.getShoppingCart().getId());
    }
    ...
    public void showFromManageItems() throws Exception {
        ...
        service.execute(null, shoppingCart.getFormId());
        Assert.assertEquals(shoppingCart.getSiteId(), service.getSite().getSiteId());
        Assert.assertEquals(null, service.getWidget());
        Assert.assertNull(service.getWidgetTitle());
        Assert.assertEquals(shoppingCart, service.getShoppingCart());
    }
    ...
    @Test(expected = ShoppingCartNotFoundException.class)
    public void showWithNotFoundShoppingCart() throws Exception {
        final Site site = TestUtil.createSite();
        TestUtil.createUserAndUserOnSiteRightAndLogin(site, SiteAccessLevel.ADMINISTRATOR);
