...
public class RenderDescriptionMetaTagTest {
    ...
    public void testExecute() {
        ...
        pageVersion.getSeoSettings().setPageDescription("page_description");

        stringBuilder.append("<!-- PAGE_HEADER -->");
        final RenderDescriptionMetaTag renderDescriptionMetaTag = new RenderDescriptionMetaTag(pageVersion, SiteShowOption.ON_USER_PAGES);
        renderDescriptionMetaTag.execute(null, stringBuilder);

        Assert.assertEquals("<meta name=\"description\" content=\"page_description\"/>\n" +
                "<!-- PAGE_HEADER -->", stringBuilder.toString());
    }

    @Test
    public void testExecuteWithoutDescription() {
        final Site site = TestUtil.createSite();
        final Page page = TestUtil.createPage(site);
        final PageManager pageVersion = new PageManager(page);
        pageVersion.getSeoSettings().setPageDescription(null);
    ...
    public void testExecuteWithEmptyDescription() {
        ...
        final Page page = TestUtil.createPage(site);
        final PageManager pageVersion = new PageManager(page);
        pageVersion.getSeoSettings().setPageDescription("");
    ...
    public void executeWithSEOInGallery() throws IOException, ServletException {
        ...
        final Render render = new RenderDescriptionMetaTag(pageVersion, SiteShowOption.ON_USER_PAGES);
        render.execute(context, stringBuilder);

        Assert.assertEquals("<meta name=\"description\" content=\"seo1;seo2;seo3\"/>\n" +
                "<!-- PAGE_HEADER -->", stringBuilder.toString());
    }
    ...
    public void executeWithSEOInGalleryData() throws IOException, ServletException {
        ...
        final Render render = new RenderDescriptionMetaTag(pageVersion2, SiteShowOption.ON_USER_PAGES);
        render.execute(context, stringBuilder);
    ...
    public void executeWithSEOAndNameInGallery() throws IOException, ServletException {
        ...
        Assert.assertEquals("<meta name=\"description\" content=\"name\"/>\n" +
                "<!-- PAGE_HEADER -->", stringBuilder.toString());
    }
    ...
    @Test
    public void executeWithNameInGalleryAndDescriptionInPage() throws IOException, ServletException {
        final Site site = TestUtil.createSite();
        final PageManager pageVersion = new PageManager(TestUtil.createPage(site));
        pageVersion.getSeoSettings().setPageDescription("description1");
        final Gallery gallery = TestUtil.createGallery(site);
        final WidgetItem galleryWidget = TestUtil.createWidgetItem();
        galleryWidget.setDraftItem((DraftItem) gallery);
        pageVersion.addWidget(galleryWidget);
        ...
        Assert.assertEquals("<meta name=\"description\" content=\"description1. name1\"/>\n" +
                "<!-- PAGE_HEADER -->", stringBuilder.toString());
    }
    ...
    public void executeWithSEOInMultipleGalleries() throws IOException, ServletException {
        ...
        Assert.assertEquals("<meta name=\"description\" content=\"seo1;seo2;seo3 seo4;seo5;seo6\"/>\n" +
                "<!-- PAGE_HEADER -->", stringBuilder.toString());
    }
    ...
    public void executeWithNameInMultipleGalleries() throws IOException, ServletException {
        ...
        Assert.assertEquals("<meta name=\"description\" content=\"name1 name2\"/>\n" +
                "<!-- PAGE_HEADER -->", stringBuilder.toString());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testInitializationWithNullPageVersion() {
        new RenderDescriptionMetaTag(null, SiteShowOption.ON_USER_PAGES);
    }
