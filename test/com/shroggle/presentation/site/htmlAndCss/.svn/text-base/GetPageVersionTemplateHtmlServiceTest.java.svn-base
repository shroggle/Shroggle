...
public class GetPageVersionTemplateHtmlServiceTest {
    ...
    public void execute() {
        ...
        Assert.assertEquals("f", service.execute(pageVersion.getPageId()));
    }
    ...
    private final GetPageVersionTemplateHtmlService service = new GetPageVersionTemplateHtmlService();
