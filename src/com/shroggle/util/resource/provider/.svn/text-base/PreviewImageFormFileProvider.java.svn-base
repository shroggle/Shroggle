 ...
 */
class PreviewImageFormFileProvider implements ResourceProvider {
    ...
    public Resource get(final ResourceRequest request) {
        ...
        return ResourceCustom.copyWithSize(resource, ResourceSizeCustom.createByWidth(PREVIEW_IMAGE_WIDTH));
    }

    private final static int PREVIEW_IMAGE_WIDTH = 100;
}
