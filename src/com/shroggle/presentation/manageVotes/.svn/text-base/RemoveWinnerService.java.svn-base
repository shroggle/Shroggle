 ...
 */
@RemoteProxy
public class RemoveWinnerService extends ServiceWithExecutePage {
    ...
    @RemoteMethod
    public String execute(final int voteId, final int manageVotesId, final SiteShowOption siteShowOption) throws IOException, ServletException {
