 ...
 * @author Artem Stasuk
 */
@UrlBinding("/site/optOutFromNetwork.action")
public class OptOutFromNetworkAction extends Action {

    @DefaultHandler
    public Resolution execute() {
        try {
            usersManager.getLogined().getRight().getSiteRight().getSiteForEdit(siteId).optOutFromNetwork();
