 ...
 */
@DataTransferObject
@Entity(name = "workFormFilterRules")
public class WorkFormFilterRule implements FormFilterRuleIface {
    ...
    @ForeignKey(name = "workFormFilterRulesWorkFormFilterId")
    private WorkFormFilter formFilter;
    ...
    public WorkFormFilter getFormFilter() {
        return formFilter;
    }
     ...
     * @see com.shroggle.entity.DraftFormFilter
     */
    void setFormFilter(final WorkFormFilter formFilter) {
