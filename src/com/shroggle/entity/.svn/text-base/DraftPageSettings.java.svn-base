...
@Entity(name = "draftPageSettings")
@Table(
        name = "draftPageSettings",
        uniqueConstraints = {
                @UniqueConstraint(columnNames = {"ownDomainName"})
        }
)
public class DraftPageSettings implements PageSettings {
    ...
    private boolean changed = false;  // todo review this. Tolik
    ...
    @ForeignKey(name = "draftPageSettingsPageId")
    private Page page;
    ...
    @ForeignKey(name = "draftPageSettingsAccessibleSettingsId")
    ...
    @RemoteProperty
    @OneToOne
    @ForeignKey(name = "draftPageSettingsBorderBackgroundId")
    @JoinColumn(name = "borderBackgroundId")
    private Border borderBackground;

    @RemoteProperty
    @OneToOne
    @ForeignKey(name = "draftPageSettingsBackgroundId")
    @JoinColumn(name = "backgroundId")
    private Background background;

    @OneToMany(cascade = CascadeType.ALL, mappedBy = "draftPageSettings")
    ...
    public void addWidget(Widget widget) {
        widget.setDraftPageSettings(this);
        widget.setWorkPageSettings(null);
        widgets.add(widget);
    }
    ...
    public void removeKeywordsGroup(KeywordsGroup keywordsGroup) {
        keywordsGroupsId.remove(Integer.valueOf(keywordsGroup.getKeywordsGroupId()));
    }
