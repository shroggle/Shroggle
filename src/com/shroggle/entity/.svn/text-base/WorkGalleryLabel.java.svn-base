 ...
 * @author Artem
 */
@Entity(name = "workGalleryLabels")
public class WorkGalleryLabel implements GalleryLabel {

    public WorkGalleryLabel() {
        align = GalleryAlign.CENTER;
        position = -1;
    }

    public WorkGalleryLabelId getId() {
        return id;
    }
    ...
    public void setId(final GalleryLabelId id) {
        this.id = (WorkGalleryLabelId)id;
    }

    @EmbeddedId
    private WorkGalleryLabelId id = new WorkGalleryLabelId();
