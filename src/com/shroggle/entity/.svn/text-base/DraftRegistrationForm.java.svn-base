...
@DataTransferObject
@Entity(name = "registrationForms")
public class DraftRegistrationForm extends DraftForm implements RegistrationForm {
    ...
    @ForeignKey(name = "registrationGroupElenetsFormId")
