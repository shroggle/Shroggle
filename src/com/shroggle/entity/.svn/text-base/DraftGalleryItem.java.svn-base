 ...
 * @author Artem Stasuk
 */
@Entity(name = "galleryItems")
public class DraftGalleryItem implements GalleryItem {

    public DraftGalleryItem() {
        this.name = "";
        this.position = -1;
    ...
    @EmbeddedId
    private DraftGalleryItemId id = new DraftGalleryItemId();
