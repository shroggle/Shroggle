 ...
 */
@Embeddable
public class DraftGalleryItemId implements Serializable, GalleryItemId {
    ...
    public boolean equals(final Object object) {
        ...
        if (object.getClass() != DraftGalleryItemId.class) return false;
        final DraftGalleryItemId galleryLabelId = (DraftGalleryItemId) object;
        return galleryLabelId.gallery == gallery && galleryLabelId.formItemId == formItemId;
    }

    @ManyToOne
    @JoinColumn(nullable = false, name = "galleryId")
    @ForeignKey(name = "galleryItemsGalleryId")
