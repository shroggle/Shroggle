 ...
 */
public class UpdatesExecutorMock extends UpdatesExecutor {

    public UpdatesExecutorMock(Updates updates) {
        if (updates == null) {
    ...
    public void execute() {
        while (updates.hasNext()) {
            ...
            logger.info("Update #" + update.getVersion() + " skipped, adding its version to DB...");
            setCurrentDataVersion(update.getVersion());
            logger.info(update.getVersion() + " updates version successfully added to DB.\n\n");
        }
