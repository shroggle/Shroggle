 ...
 */
public class ItemNamingRealWithAddingCopyWord implements ItemNaming {

    @Override
    public String execute(
            final ItemType type, final int siteId, final String customNamePattern,
            final boolean dontUseFirstNumber) {
        return SiteItemsManager.getNextDefaultName(type, siteId, (customNamePattern + "_copy"), dontUseFirstNumber);
    }
