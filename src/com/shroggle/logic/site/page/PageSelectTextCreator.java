 ...
 */
public class PageSelectTextCreator {
    ...
    public String execute(final int siteId, final SiteShowOption siteShowOption) {
        ...
        final DefaultMenuPagesHtmlTextCreator pagesHtmlTextCreator = new DefaultMenuPagesHtmlTextCreator();
        pagesHtmlTextCreator.setLimitPageName(25);
        pagesHtmlTextCreator.setForSelect(true);
        return pagesHtmlTextCreator.create(site, siteShowOption);
    }
