 ...
 *Adds several Formatting functions for formatting that values provided on the file object.
 ...
 - SWFUpload.speed.formatBytes(bytes) -- outputs string formatted in the best units (w GB x MB y KB z B )
...
if (typeof(SWFUpload) === "function") {
    ...
    SWFUpload.speed.formatTime = function (baseNumber) {
        var timeUnits = [86400, 3600, 60, 1], timeUnitLabels = ["day(s)", "hour(s)", "minute(s)", "second(s)"];
